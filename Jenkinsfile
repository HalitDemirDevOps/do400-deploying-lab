        ...
        stage('Deploy to TEST') {
            ...
            steps {
                sh """
                    ...
                    oc project jenkins
                    oc set image deployment ${DEPLOYMENT_STAGE} home-automation home-automation-stage=quay.io/${QUAY_USR}/do400-deploying-lab:build-${BUILD_NUMBER} -n jenkins --record
                """
            }
        }
